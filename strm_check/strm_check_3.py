...
Note: Only the watersheds for which streamflow data is avaialble between 1982 and 2014 is copied
...
list_complete_watersheds = list_complete_watersheds_0 + list_complete_watersheds_1 + list_complete_watersheds_2
...
for fname in remaining_basins:
   #   fname = '01047000_GLEAMS_CAMELS_data.txt'
    ...
    if (len_missing_ind == 0 and len_nan_ind == 0):
        shutil.copy(filename,direc + '/CAMELS_GLEAMS_combined_data/complete_watersheds_3')