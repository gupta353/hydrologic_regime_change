...
Note: Only the watersheds for which streamflow data is avaialble between 1980 and 2011 is copied
...
list_complete_watersheds = list_complete_watersheds_0 + list_complete_watersheds_1 + list_complete_watersheds_2 + list_complete_watersheds_3 + list_complete_watersheds_4 + list_complete_watersheds_5 + list_complete_watersheds_6
...
for fname in remaining_basins:
   #   fname = '01047000_GLEAMS_CAMELS_data.txt'
    ...
    end_date = datetime.date(2011,9,30)
    ...
    if (len_missing_ind == 0 and len_nan_ind == 0):
        shutil.copy(filename,direc + '/CAMELS_GLEAMS_combined_data/complete_watersheds_7')